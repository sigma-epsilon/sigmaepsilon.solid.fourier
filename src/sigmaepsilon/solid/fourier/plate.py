...
class RectangularPlate(NavierProblem):
    ...
    def __init__(
        ...
        shape: Tuple[int],
        *,
        D11: Optional[Union[float, None]] = None,
        D12: Optional[Union[float, None]] = None,
        D22: Optional[Union[float, None]] = None,
        D66: Optional[Union[float, None]] = None,
        S44: Optional[Union[float, None]] = None,
        S55: Optional[Union[float, None]] = None,
        D: Optional[Union[Iterable, None]] = None,
        S: Optional[Union[Iterable, None]] = None,
    ):
        super().__init__()
